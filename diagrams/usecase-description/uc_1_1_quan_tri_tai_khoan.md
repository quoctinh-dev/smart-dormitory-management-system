...
| **Luồng sự kiện chính** | 1. Actor chọn chức năng Quản trị Tài khoản và Phân quyền.<br>2. Hệ thống hiển thị màn hình Quản trị Tài khoản & Phân quyền.<br><br>_Các kịch bản mở rộng (Extend):_<br>- Extend Use Case **Đăng nhập**.<br>- Extend Use Case **Kích hoạt tài khoản (CCCD)**.<br>- Extend Use Case **Đăng xuất**.<br>- Extend Use Case **Quên & Đặt lại mật khẩu**.<br>- Extend Use Case **Đổi mật khẩu**.<br>- Extend Use Case **Tạo tài khoản (Cán bộ)**.<br>- Extend Use Case **Xem danh sách tài khoản**.<br>- Extend Use Case **Khóa/Mở khóa tài khoản**. |
...
*   **Bước 3:** Hệ thống tạo Secure Token (giới hạn 15 phút) và gửi Email chứa liên kết khôi phục.
*   **Bước 4:** Actor click vào liên kết và nhập Mật khẩu mới.
...
> **Rẽ nhánh 8.1 (Không thể khóa chính mình):**
> - *Bước 1.1:* Admin chọn khóa tài khoản của chính mình.
> - *Bước 2.1:* Hệ thống chặn lại và báo lỗi (ErrorCode: CANNOT_LOCK_SELF).
> 
> **Rẽ nhánh 8.2 (Không thể khóa Admin khác):**
> - *Bước 1.2:* Admin chọn khóa một tài khoản Admin khác đang hoạt động.
> - *Bước 2.2:* Hệ thống chặn lại và báo lỗi (ErrorCode: CANNOT_LOCK_ADMIN).
> 
> **Rẽ nhánh 8.3 (Khóa tài khoản chưa kích hoạt):**
> - *Bước 1.3:* Admin chọn khóa tài khoản sinh viên đang ở trạng thái PENDING_ACTIVATION.
> - *Bước 2.3:* Hệ thống báo lỗi trạng thái không hợp lệ.
