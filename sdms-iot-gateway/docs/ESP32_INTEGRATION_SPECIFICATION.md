...
*   **Python AI là AI Engine:** Một Microservice độc lập chạy trên máy chủ để trích xuất đặc trưng khuôn mặt (512-dimension vector) từ ảnh do ESP32 gửi lên.
...
*   **Python AI Service:**
    *   Nhận File ảnh từ Backend, trích xuất Vector đặc trưng (512-float array).
*   **Database (PostgreSQL):**
