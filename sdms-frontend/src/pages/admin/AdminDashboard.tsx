...
export default function AdminDashboard() {
    ...
    const getBillStatusOption = () => {
        ...
        const statusConfig: Record<string, { label: string, color: string }> = {
            PAID: {label: 'Đã thanh toán', color: theme.palette.success.main},
            UNPAID: {label: 'Chưa thanh toán', color: theme.palette.error.main},
            PARTIALLY_PAID: {label: 'Thanh toán 1 phần', color: theme.palette.warning.main},
            OVERDUE: {label: 'Quá hạn', color: theme.palette.text.secondary},
            CANCELLED: {label: 'Đã hủy', color: theme.palette.grey[400]}
        };

        const pieData = Object.keys(map)
            .map(k => ({
                name: statusConfig[k]?.label || k,
                value: map[k],
                itemStyle: {color: statusConfig[k]?.color || theme.palette.primary.main}
            }))
            .filter(i => i.value > 0);
            ...
            <Box mb={3} display="flex" justifyContent="space-between" alignItems="center">
                <Box mb={4}>
                    ...
                    <Typography
                        ...
                        sx={{ fontWeight: 400, fontSize: '0.925rem' }}
                    >
                        Xin chào{' '}
                        <Box component="span" sx={{ color: 'primary.main', fontWeight: 700 }}>
                            {user?.username || 'Quản trị viên'}
                        </Box>
                        , dưới đây là tình hình hoạt động & cơ sở vật chất KTX.
                    </Typography>
                </Box>
                    ...
                    <Grid size={{xs: 12, xl: 4}}>
                        <Paper variant="outlined"
                                        ...
                                        <Box sx={{
                                            ...
                                            <Box>
                                                ...
                                                <Typography variant="caption"
                                                            color="text.secondary">{item.label}</Typography>
                                            </Box>
                                        </Box>
                                    </Grid>
                                ))}
                            ...
                            <Box sx={{flexGrow: 1, minHeight: 180, mt: -2}}>
                                <ReactECharts option={getOccupancyGaugeOption()}
                        ...
                        <Grid size={12}>
                            <Paper variant="outlined"
                                ...
                                <Box sx={{flexGrow: 1, height: 350}}>
                                    <ReactECharts option={getTrafficChartOption()}
                                                  style={{height: '100%', width: '100%'}}/>
                                </Box>
                            </Paper>
                        </Grid>
                    ...
                    <Grid size={{xs: 12, md: 4}}>
                        <Paper variant="outlined"
                            ...
                            <Box sx={{flexGrow: 1, minHeight: 320}}>
                                <ReactECharts option={getApplicationStatusOption()}
                                              style={{height: '100%', width: '100%'}}/>
                            </Box>
                        </Paper>
                    </Grid>
                    ...
                    <Grid size={12}>
                        <Paper variant="outlined" sx={{p: 3, borderRadius: 2}}>
                            <Box display="flex" alignItems="center" gap={2} mb={3}>
                                ...
                                <Chip label={expiringList?.length || 0} color="warning" size="small"
                                            ...
                                            <TableRow>
                                                <TableCell colSpan={6} align="center" sx={{py: 6}}>
                                                    <Typography color="text.secondary" variant="body2"
                                                                fontStyle="italic">Không có sinh viên nào sắp hết hạn
                                                        trong 7 ngày tới.</Typography>
                                                </TableCell>
                                            </TableRow>
                                        ) : (
