...
export default function FaceApprovalQueue() {
    ...
    const emptySlotsCount = displayedProfiles.length > 0 && displayedProfiles.length < 4
        ? 4 - displayedProfiles.length
        : 0;
                ...
                <>
                    ...
                    <Grid container spacing={2.5}>
                        ...
                        {Array.from({ length: emptySlotsCount }).map((_, index) => (
                            <Grid size={{ xs: 12, sm: 6, md: 4, lg: 3 }} key={`empty-slot-${index}`}>
                                <Box
                                    sx={{
                                        height: '100%',
                                        minHeight: 380,
                                ...
                                >
                                    <CameraFrontIcon sx={{ fontSize: 40, mb: 1.5, opacity: 0.3 }} />
