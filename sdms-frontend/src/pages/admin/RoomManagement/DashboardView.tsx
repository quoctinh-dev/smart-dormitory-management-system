...
export default function DashboardView({ roomsWithBeds }: DashboardViewProps) {
            ...
            >
              <CardContent sx={{ p: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                  Trạng thái phòng:{' '}
                  <strong style={{ color: room.status === 'ACTIVE' ? '#2563eb' : '#94a3b8' }}>
                    {room.status}
                  </strong>
                </Typography>
                  ...
                  <Grid container spacing={1}>
                    {room.beds?.map((bed, bedIdx) => {
                      ...
                      return (
                        ...
                        <Grid key={bId}>
                          <Tooltip
                            title={`Giường số: ${bed.bedNumber || bedIdx + 1} (${bed.status})`}
                            arrow
                          >
                            <Box
                              sx={{
