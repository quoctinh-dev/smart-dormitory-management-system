        ...
        <Box>
            ...
            >
                <Container maxWidth="md">
                    <Typography variant="h3" sx={{ mb: 2, fontWeight: 700, letterSpacing: '-0.5px', lineHeight: 1.3 }}>
                        Cổng đăng ký lưu trú trực tuyến
                    </Typography>
                    <Typography variant="h6" sx={{ opacity: 0.9, mb: 6, fontWeight: 400, maxWidth: 700, mx: 'auto', lineHeight: 1.5 }}>
