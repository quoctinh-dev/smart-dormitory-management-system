    ...
    return (
        ...
        >
            <Container maxWidth="md">
                ...
                <Typography
                    variant="body2"
                    sx={{ color: 'text.secondary', textAlign: 'center', mb: 6, fontWeight: 400 }}
                >
                    ...
                    >
                        {REGISTRATION_STEPS.map((step, index) => (
                            <Step key={step.label} active={true}>
                                ...
                                >
                                    <Typography variant="subtitle1" sx={{ fontWeight: 700, color: 'text.primary', pl: 0.5 }}>
                                        {step.label}
                                    </Typography>
                                </StepLabel>
                                <StepContent
                                    sx={{
                                        ...
                                        pb: index === REGISTRATION_STEPS.length - 1 ? 0 : 3.5
                                    }}
                                >
                                    <Typography
                                        variant="body2"
