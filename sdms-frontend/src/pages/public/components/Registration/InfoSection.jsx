...
export default function InfoSection({ formData, error, setFormData }) {
  ...
  const handleNumberFieldChange = (field, maxLength) => (e) => {
  ...
  const handlePriorityChange = (e) => {
    setFormData((prev) => ({ ...prev, priorityCategories: [e.target.value] }));
  };

  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, maxWidth: 600, mx: 'auto', mt: 4 }}>
      <Alert severity="success" sx={{ borderRadius: 3 }}>
        Hệ thống xác nhận bạn đủ điều kiện nộp hồ sơ. Vui lòng cung cấp đầy đủ các thông tin cá nhân dưới đây.
      </Alert>
