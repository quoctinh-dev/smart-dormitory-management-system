    ...
    <Box>
      ...
      <Dialog open={dialogOpen} onClose={handleCloseDialog} maxWidth="sm" fullWidth>
        ...
        <DialogContent dividers>
          ...
          {checkResult.success && (
            <Typography variant="body1" sx={{ mt: 2, color: 'text.secondary' }}>
              Hệ thống ghi nhận thông tin của bạn hoàn toàn hợp lệ. Vui lòng nhấn <strong>"Đăng ký ngay"</strong> để bắt đầu quá trình khai báo hồ sơ nội trú.
            </Typography>
          )}
        </DialogContent>
        <DialogActions sx={{ p: 2, gap: 1 }}>
          ...
          {checkResult.success && (
            <Button variant="contained" color="primary" onClick={handleNavigateRegister} sx={{ px: 3 }}>
              Đăng ký ngay
            </Button>
          )}
        </DialogActions>
