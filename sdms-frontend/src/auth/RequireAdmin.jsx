...
export default function RequireAdmin() {
  ...
  const isAuthorized = admin && ['ADMIN', 'STAFF'].includes(admin.role);
      ...
      >
        <Container maxWidth="xs">
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
            Tài khoản của bạn không có đặc quyền truy cập khu vực quản trị. Hệ thống sẽ tự động đưa bạn quay lại Trang chủ.
          </Typography>
