import { Box, AppBar, Toolbar, Typography, Container, Avatar, Stack, Link, CssBaseline } from '@mui/material';
...
s
      ...
      >
        <Container>
          <Stack direction={{ xs: 'column', md: 'row' }} justifyContent="space-between" spacing={6} sx={{ mb: 6 }}>
            <Box sx={{ maxWidth: 400 }}>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={8}>
              <Box>
                <Typography variant="subtitle2" sx={{ fontWeight: 'bold', color: 'common.white', mb: 2 }}>
                  LIÊN KẾT NHANH
                </Typography>
                <Stack spacing={1.5}>
