...
public class GateMapper {
    ...
    public GateResponse toResponse(Gate gate) {
        return GateResponse.builder()
                ...
                .buildingId(gate.getBuilding() != null ? gate.getBuilding().getBuildingId() : (gate.getRoom() != null ? gate.getRoom().getFloor().getBuilding().getBuildingId() : null))
                .buildingName(gate.getBuilding() != null ? gate.getBuilding().getName() : (gate.getRoom() != null ? gate.getRoom().getFloor().getBuilding().getName() : null))
