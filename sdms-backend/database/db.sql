...
INSERT INTO user_accounts (account_id,
                           username,
                           email,
                           password,
                           role,
...
INSERT INTO buildings (building_id, code, name, description, status, created_at, updated_at)
VALUES ('b2222222-2222-2222-2222-222222222222', 'B', 'Tòa B (Nữ)', 'Khu KTX dành cho Nữ sinh viên', 'ACTIVE',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
VALUES ('f1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 1, 'MALE', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP),
       ('f2222222-2222-2222-2222-222222222222', 'b2222222-2222-2222-2222-222222222222', 1, 'FEMALE', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP);
...
VALUES ('c1111111-1111-1111-1111-111111111111', 'f1111111-1111-1111-1111-111111111111', 'A101', 4, 0, 'AVAILABLE',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('c2222222-2222-2222-2222-222222222222', 'f2222222-2222-2222-2222-222222222222', 'B101', 2, 0, 'AVAILABLE',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- 4. Thêm Giường (Beds)
INSERT INTO beds (bed_id, room_id, bed_code, status, note, created_at, updated_at)
VALUES ('d1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'A101-01', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('d2111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'A101-02', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('d3111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'A101-03', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('d4111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'A101-04', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('d5222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222222', 'B101-01', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
       ('d6222222-2222-2222-2222-222222222222', 'c2222222-2222-2222-2222-222222222222', 'B101-02', 'AVAILABLE', NULL,
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
